...
import { UserPlus, Mail, Lock, Check, Loader2 } from 'lucide-react';
        ...
        <div className="bg-card rounded-2xl shadow-xl border border-border/50 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <Check className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-foreground/40" />
                <input
                  id="confirmPassword"
                  type="password"
          ...
          <div className="mt-8 text-center">
            <p className="text-foreground/70 text-sm mb-4">
              After registration, you can customize your profile and upload a profile picture in the settings.
            </p>
